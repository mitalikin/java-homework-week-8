...
* if the number is negative then the method need to return-1 to indicate an invalid value.
* Example input/output
* sumFirstAndLastDigit(252); →should return 4, the first digit is 2 and the last is 2 which gives us 2+2 and the sum is4
 ...
 */
public class FirstAndLastDigitSumP7 {
